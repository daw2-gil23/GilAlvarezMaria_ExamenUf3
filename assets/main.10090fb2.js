...
const cervezas = [
  {
    id: 1,
    nombre: "IPA",
    imageUrl: "https://www.dougalls.es/ext/r/oxo-1267/cerveza-dougalls-botella-ipa-4.png",
    description: "India Pale Ale (IPA) es un estilo de cerveza muy popular que se caracteriza por su alto contenido de l\xFApulo y un sabor amargo. Las IPA tienen una apariencia dorada y un aroma a l\xFApulo fresco y c\xEDtricos. Son ideales para los amantes de los sabores fuertes y las cervezas intensas."
  },
  {
    id: 2,
    nombre: "Stout",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/3/3a/Guinness_7686a.jpg",
    description: "La Stout es una cerveza oscura y fuerte que se caracteriza por su sabor a caf\xE9, chocolate y tostado. Es una cerveza de cuerpo completo con un sabor suave y cremoso. Perfecta para tomar en invierno y maridar con postres y carnes asadas."
  },
  {
    id: 3,
    nombre: "Pilsner",
    imageUrl: "https://www.birra365.com/92-large_default/cerveza-pilsen-urquell-pilsner-33cl.jpg",
    description: "La Pilsner es una cerveza clara y ligera de origen checo que se caracteriza por su sabor fresco y refrescante. Tiene un aroma suave a l\xFApulo y un sabor limpio y crujiente. Es ideal para tomar en d\xEDas calurosos y combina bien con platos ligeros y ensaladas."
  },
  {
    id: 4,
    nombre: "Wheat beer",
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/f/f0/2013_Augustiner_Weissbier_Munich_pub.jpg",
    description: "La Wheat beer es una cerveza de trigo que se caracteriza por su sabor afrutado y suave. Tiene un aroma a pl\xE1tano y clavo de olor y un sabor a malta y levadura. Es una cerveza f\xE1cil de beber y se recomienda para maridar con platos de mariscos y comida picante."
  }
];
const descripcion = {
  template: ``,
  script: (id) => {
    ...
    const html = `
        ...
        `;
    const descripcion2 = document.querySelector("#descripcionCervezas");
    descripcion2.innerHTML = html;
  }
};
let getRandomValues;
  ...
  script: () => {
    ...
    main2.addEventListener("click", (event) => {
      if (event.target.classList.contains("eliminar")) {
        ...
        alert("Est\xE1s borrando el usuario con id: " + cervezaID);
